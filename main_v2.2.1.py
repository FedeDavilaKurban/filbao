...
theta_max = 40.0   # angular radius in degrees
...
def plot_radec_distribution(cat: pd.DataFrame, randoms: pd.DataFrame, subsample: int=None) -> None:
    ...
    axes[1].legend()
    if subsample==None:
        filename = f"../plots/radec_distribution_{name_modifier}.png"
        axtitle = 'Total sample'
    else:
        filename = f"../plots/radec_distribution_{name_modifier}_bin{subsample}.png"
